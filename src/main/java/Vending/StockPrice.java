 ...
 * números reais o respectivo valor de cada item.
 * 
 * 
...
public class StockPrice {
   final public static int MINSEL = 1; // �?ndice do primeiro item
   final public static int MAXSEL = 20; // �?ndice do último item
